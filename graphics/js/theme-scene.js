function init() {
    ...
    var container, stats;
    var camera, cameraControls, controls, scene, renderer, cubesCoords;
    var cross, yellowLight, greyLight, object, loader, beatIt;
    ...
    function init() {
        ...
        //var selectedObject = scene.getObjectByName(object.cube);
